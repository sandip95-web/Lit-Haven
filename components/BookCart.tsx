...
const BookCart = ({ cart, totalPrice }: { cart: any, totalPrice: number }) => {
  ...
  return (
    <div className="bg-white shadow-2xl rounded-3xl overflow-hidden mx-auto w-full max-w-5xl">
      {cart.length === 0 ? (
            ...
            >
              <div className="flex items-center w-full sm:w-2/3">
                ...
                <div className="ml-6 flex flex-col justify-center w-full">
                  <h2 className="text-xl font-bold text-gray-900 truncate">{product.bookTitle}</h2>
